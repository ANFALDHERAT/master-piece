...
<!-- Header Section End -->
    ...
    <!-- Page Title/Header Start -->
    <div class="page-title-section section"data-bg-image="assets/images/laser2.jpg" style="height: 600px;" >
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="page-title">
                        ...
                        <br>
                        <br>
                        <h2 class="title" style="margin-left: 60%;">Laser Experts</h2>
                        <ul class="breadcrumb">
                            <h3 class="title" style="font-size: 25px;color: black;margin-left: 60%;">Leaders in Laser Excellence</h3>
            ...
            <div id="shop-products" class="products isotope-grid row row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details-sticky.html" class="image">
                                <img src="assets/images/l1.jpg" alt="Product Image" style="height: 250px;border-radius: 10px;">
                ...
                <div class="grid-item col featured">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details-sticky.html" class="image">
                                <img src="assets/images/l2.jpg" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                ...
                <div class="grid-item col featured">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details-sticky.html" class="image">
                                <img src="assets/images/l3.jpg" alt="Product Image" style="height:250px;border-radius: 10px;">
                                <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                ...
                <div class="grid-item col featured">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details-sticky.html" class="image">
                                <img src="assets/images/l4.jpg" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
