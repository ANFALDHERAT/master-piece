...
<body>
    ...
    <div class="page-title-section section" data-bg-image="assets/images/o9.jpg" style="height: 550px;"  >
        <div class="container">
            <div class="row">
                <div class="col">
                ...
                <div id="shop-products" class="products isotope-grid row row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma1.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                            ...
                            <div class="product-info">
                                ...
                                <p class="expert-location">
                                    <i class="fas fa-map-marker-alt" style="margin-bottom: 10px;color: #e66b5a;"></i> Location: Irbid <!-- Add the location information here -->
                                </p>         
                                <div >
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma2.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma3.jfif" alt="Product Image" style="height:250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma4.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma5.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma6.jfif" alt="Product Image" style="height:250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma7.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
                    ...
                    <div class="grid-item col featured">
                        ...
                        <div class="product">
                            <div class="product-thumb">
                                <a href="product-details-sticky.html" class="image">
                                    <img src="assets/images/ma8.jfif" alt="Product Image" style="height: 250px;border-radius: 10px;">
                                    <!-- <img class="image-hover " src="assets/images/Compre Online Linha de Maquiagem Mariana Saad by Océane.png" alt="Product Image" style="height:270px;border-radius: 10px;"> -->
                                </a>
                                <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                            </div>
