            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="page-title">
                        <h1 class="title">Medical beauty centers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"  style="font-size: 25px;color: black;"><a href="/">Home</a></li>
                            <li class="breadcrumb-item"  style="font-size: 25px;color: black;"><a href="#">Medical beauty centers</a></li>
            ...
            <div class=" row learts-mb-n40">
                ...
                <div class="col-lg-5 col-12 learts-mb-40">
                        ...
                        <!-- <span class="product-badges">
                            ...
                            <img src="{{ url('/assets1/images/' . $medical->image) }}" alt="" style="height:400px;width: 400px;">
                </div>
                ...
                <div class="col-lg-5 col-6 learts-mb-40">
                                    ...
                                    <div class="sticky-sidebar-inner">
                                        <h3 class="product-title">{{ $medical->name }}</h3>
                                        <div class="product-ratings"  style="color: #F8796C;">
                                            <span class="stars">
                                                @for ($i = 1; $i <= $medical->average_rating; $i++)
                                                    &#9733;
                                                @endfor
                                            </span>
                                        ...
                                        <div class="product-description">
                                            <main class="expert-profile">
                                                <div class="expert-details">
                                                    ...
                                                    <p>Address: {{  $medical->service_area}}</p>
