            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="page-title">
                        <h1 class="title">a Medical beauty centers</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"  style="font-size: 25px;color: black;"><a href="/">Home</a></li>
                            <li class="breadcrumb-item"  style="font-size: 25px;color: black;"><a href="/medical">Medical beauty centers</a></li>
                ...
                <div class="grid-item col featured">
                    ...
                    <div class="product">
                        ...
                        <div class="product-info">
                            ...
                            <div >
                                <a href="{{ route('MedicalDetails.index', ['id' => $expert->id]) }}" class="btn btn-dark btn-outline-hover-dark">More Detail</a>
                            </div>
