...
<body>
    ...
    <!-- Icon Box Style One Section Start -->
    <div class="section section-padding">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Icon Box 01</h2>
            </div>
            <!-- Section Title End -->
    ...
    <!-- Icon Box Style One Section End -->

    <!-- Icon Box Style Two Section Start -->
    <div class="section section-padding border-top">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Icon Box 02</h2>
            </div>
            <!-- Section Title End -->
            <div class="row row-cols-md-3 row-cols-1 learts-mb-n30">
                ...
                <div class="col learts-mb-30">
                    <div class="icon-box2">
                        <div class="inner">
                            ...
                            <div class="content">
                                <h6 class="title">FREE SHIPPING & RETURN</h6>
    ...
    <!-- Icon Box Style Two Section End -->

    <!-- Icon Box Style Three Section Start -->
    <div class="section section-padding border-top">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Icon Box 03</h2>
            </div>
            <!-- Section Title End -->
    ...
    <!-- Icon Box Style Three Section End -->
