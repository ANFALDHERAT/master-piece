...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12">
            ...
            @endif
                <a href=" {{ url('/ServicePrice/create') }}"> <button class="btn btn-primary mb-2">Add New Service Price
                   </button></a>
               ...
               <td> <a href="{{ url('/ServicePrice/' . $item->id . '/edit') }}"> <button
                   ...
                   <form method="POST" action="{{ url('/ServicePrice' . '/' . $item->id  ) }}" style="display: inline;">
                        @csrf
                        @method('DELETE')
